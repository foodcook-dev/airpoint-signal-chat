    ...
    <div className="max-w-[600px]">
      {ogTags.map((og, index) => (
        <div key={index} className="rounded-lg overflow-hidden bg-white shadow-sm">
          ...
          <div className="p-3">
            <h3 className="font-medium text-sm text-gray-900 line-clamp-2 mb-1">{og.og_title}</h3>
            <p className="text-xs text-gray-600 line-clamp-3 mb-1">{og.og_description}</p>
